  ...
  if (isset($_GET['id'])) {
    ...
    $data = mysqli_fetch_assoc($result);
      // apabila data tidak ada pada database maka akan dijalankan perintah ini
       if (!count($data)) {
          echo "<script>alert('Data tidak ditemukan pada database');window.location='galery.php';</script>";
       }
  } else {
    // apabila tidak ada data GET id pada akan di redirect ke index.php
    echo "<script>alert('Masukkan data id.');window.location='galery.php';</script>";
  }         
  ?>
<!DOCTYPE html>
<html>
  ...
  <body>
      <center>
        <h1>Edit Photo <?php echo $data['judul']; ?></h1>
      <center>
      <form method="POST" action="proses_editfoto.php" enctype="multipart/form-data" >
      <section class="base">
